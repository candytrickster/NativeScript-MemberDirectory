...
exports.loaded = (args) => {
    ...
    for (var i = 0; i< members.length; i++) {
		var member = { name: members[i].name, title: members[i].title, img: members[i].image, id:members[i].id } //http images were blocked for security reasons so you needed to config a thing in info.plist
